...
![Illustration of a browser window on the screen. The square marks the origin of the screen coordinates; triangle of the page displayed in the browser; circle of the desired viewport coordinates](./figures/coordinates.jpeg){#fig:coordinates}
